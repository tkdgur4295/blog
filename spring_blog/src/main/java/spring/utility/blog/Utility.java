...
public class Utility {
	 ...
	 * @return 페이징 생성 문자열
	 */
	public static String rmemopaging(int totalRecord, int nPage, int recordPerPage, String url, int memono, int nowPage,
			String col, String word) {
		int pagePerBlock = 10; // 블럭당 페이지 수
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage)); // 전체
																					// 페이지
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&no=" + memono + "&nPage=" + _nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col
						+ "&word=" + word + "&no=" + memono + "&nPage=" + i + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&no=" + memono + "&nPage=" + _nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
